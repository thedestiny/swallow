package com.destiny.swallow.generator;
...
public class MysqlGenerator {
	...
	public static void main(String[] args) {
		...
		String outputDir = "D:/generator/code";
...
//		strategy.setTablePrefix(new String[] { "bmd_", "mp_" });// 此处可以修改为您的表前缀
		...
		// 自定义 controller 父类
		strategy.setSuperControllerClass("com.destiny.swallow.base.BaseController");
		...
		pc.setParent("com.destiny.swallow"); // 自定义包路径
