package com.destiny.swallow.commons.shiro.captcha;
...
import com.destiny.swallow.commons.utils.StringUtils;
import com.destiny.swallow.commons.utils.WebUtils;
 ...
 *
 */
public class SwallowCaptcha implements InitializingBean {
	private final static Logger logger = LogManager.getLogger(SwallowCaptcha.class);
